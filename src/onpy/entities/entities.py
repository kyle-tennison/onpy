...
from onpy.entities.protocols import FaceEntityConvertible, VertexEntityConvertible, BodyEntityConvertible, EdgeEntityConvertible
...
class Entity:
    ...
    def as_featurescript(cls) -> str:
        ...
        raise NotImplementedError("An entity of unknown type should never be parsed into featurescript")
